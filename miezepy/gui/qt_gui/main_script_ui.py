...
"")
        ...
        self.progress_bar_reduction = QtWidgets.QProgressBar(self.groupBox_2)
...
"")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.process_button_plot_hide.sizePolicy().hasHeightForWidth())
        self.process_button_plot_hide.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, script_widget):
        ...
        self.label_11.setText(_translate("script_widget", "x curve num +"))
