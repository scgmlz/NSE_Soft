...
"")
        ...
        self.script_text_set_fit = QtWidgets.QTextEdit(self.script_tab_set_fit)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.script_button_set_fit_gui = QtWidgets.QPushButton(self.script_tab_set_fit)
        ...
        self.script_button_set_fit_run = QtWidgets.QPushButton(self.script_tab_set_fit)
        ...
        self.script_tabs.addTab(self.script_tab_set_fit, "")
    ...
    def retranslateUi(self, script_widget):
        ...
        self.script_button_set_fit_gui.setText(_translate("script_widget", "Send to GUI"))
        self.script_button_set_fit_run.setText(_translate("script_widget", "Run"))
        self.script_tabs.setTabText(self.script_tabs.indexOf(self.script_tab_set_fit), _translate("script_widget", "Fit parameters"))
