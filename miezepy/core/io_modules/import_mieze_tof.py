...
class Import_MIEZE_TOF:
    ...
    def process_input_tof(self,load_path, target):
        ...
        text fill and try to parse the informatiion
        in order to generatr a dictionary that will
        ...
        for line in lines:
            ...
            ########################################
            #if we have a data line process the info 
