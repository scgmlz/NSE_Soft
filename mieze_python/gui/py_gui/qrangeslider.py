...
#found on https://stackoverflow.com/questions/47342158/porting-range-slider-widget-to-pyqt5
...
class Element(QtWidgets.QGroupBox):
    ...
    def textColor(self):
        return getattr(self, '__textColor', QtGui.QColor(0, 0, 0))
...
class QRangeSlider(QtWidgets.QWidget, Ui_Form):
    ...
    def __init__(self, parent=None):
        ...
        self.handle.setTextColor((43, 0, 255))
