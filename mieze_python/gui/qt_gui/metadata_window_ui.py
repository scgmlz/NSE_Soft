...
class Ui_select_meta(object):
    def setupUi(self, select_meta):
        ...
        self.meta_button_cancel = QtWidgets.QPushButton(self.centralwidget)
        self.meta_button_cancel.setObjectName("meta_button_cancel")
        self.horizontalLayout_2.addWidget(self.meta_button_cancel)
        self.meta_button_accept = QtWidgets.QPushButton(self.centralwidget)
        ...
        select_meta.setCentralWidget(self.centralwidget)
        ...
        self.statusbar = QtWidgets.QStatusBar(select_meta)
        self.statusbar.setObjectName("statusbar")
        select_meta.setStatusBar(self.statusbar)
    ...
    def retranslateUi(self, select_meta):
        ...
        self.meta_button_cancel.setText(_translate("select_meta", "Cance"))
