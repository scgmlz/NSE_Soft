...
class Ui_env_widget(object):
    def setupUi(self, env_widget):
        ...
        env_widget.setMinimumSize(QtCore.QSize(0, 159))
        env_widget.setMaximumSize(QtCore.QSize(16777215, 159))
        env_widget.setBaseSize(QtCore.QSize(0, 159))
    ...
    def retranslateUi(self, env_widget):
        ...
        self.env_button_scripts.setText(_translate("env_widget", "Scipts"))
